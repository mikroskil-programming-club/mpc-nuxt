...
grid 1x6 : naomi ray tristan fikri usman sam
if di hape
flex column:
flex row naomi
flex row ray and so on
...
GET TASK: return table task, {title: , status:} (ON PROGRESS TGL 01/02)
Task component:
Props : title, status
...
dialog : “Halo (nama), silahkan registrasi dengan password untuk login ya”) (NOT YET, ON PROGRESS TGL 01/02)
...
(Didalam modal bisa reset password member, utk bantu yang lupa pw) (NOT YET, ON PROGRESS TGL 01/02)
...
NuxtLink Profile: (NOT YET, ON PROGRESS 01/02)
