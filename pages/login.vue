        ...
        <div class="flex flex-col">
          ...
          <div class="flex items-center gap-2 justify-center">
            ...
            <div
              ...
              class="md:hidden cursor-pointer bg-gray-300 w-[80px] text-center rounded-md hover:bg-gray-400 p-1 font-semibold"
            >
              {{ hidePasswordValue }}
            </div>
            <div
              ...
              class="hidden md:block cursor-pointer bg-gray-300 w-[80px] text-center rounded-md hover:bg-gray-400 p-1 font-semibold"
            >
              {{ hidePasswordValue }}
            </div>
          </div>
